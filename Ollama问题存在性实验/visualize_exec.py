...
msgspec/peewee/niquests, or by exec_oracle/run_exec_eval.py for simplug) plus
run_config.json, and renders figures sliced by method x {model, pair_type,
difficulty} -- the whole point of the per-task pair_type/difficulty metadata.
...
the experiment interpreter.
    ...
    python3 visualize_exec.py --result-dir result/msgspec_5model
    python3 visualize_exec.py --result-dir result/msgspec_5model --metric run
